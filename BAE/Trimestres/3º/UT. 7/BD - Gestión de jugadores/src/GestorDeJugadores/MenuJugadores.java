...
// Importa el paquete "BDGestionDeJugadores".
    import com.mongodb.GestorDeJugadores.BDGestionDeJugadores; /* Con esta sentencia lo que hacemos es importar el archivo creado anteriormente 'BDGestionDeJugadores.java' hasta este archivo. */
    import java.util.*;


// Crea la clase "MenuJugadores" donde se encuentra el menú interactivo.
public class MenuJugadores /*extends BDGestionDeJugadores*/{
    ...
    public static void main(String[] args){
        ...
        // Declara una variable numérica, ésta servirá como puente entre las opciones a escoger dentro del bucle.
        int opcion;
        ...
        do{
            ...
            // Crea un bucle de tipo "while" para comprobar que el número introducido por el usuario corresponda con lo solicitado, es decir, que sea entero y esté comprendido dentro del rango de opciones/acciones a ejecutar (1-6).
            while (!usuario.hasNextInt()){ /* Con "hasNextInt" lo que hacemos es comprobar o verificar si el token/instancia introducida como valor de la variable numérica "opcion" por el usuario es leído como lo que es un entero, "int", en caso de serlo devolverá true, en caso contrario dará "false". */
            ...
            // Declara un condicional de tipo "switch", se podría haber saltado/omitido el paso o el hecho de haberlo declarado dentro del "do", pero de esta manera nos aseguramos de que se ejecute al menos una vez.
            switch (opcion){
                /*
