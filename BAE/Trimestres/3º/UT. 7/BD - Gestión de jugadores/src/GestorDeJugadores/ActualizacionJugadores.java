...
public class ActualizacionJugadores{
    ...
    public void ejecutarActualizacionJugador(){
        ...
        switch (campoActualizadoFinal){
            ...
            case "Nombre":
                if (parametroActualizado.length() < 2 || !parametroActualizado.matches("[a-zA-Záéíóú�?ÉÍÓÚÜäëïöüÄËÏÖÜàèìòùÀ�?ÌÒÙâêîôûÂÊÎÔÛñÑ\\s]+")){
