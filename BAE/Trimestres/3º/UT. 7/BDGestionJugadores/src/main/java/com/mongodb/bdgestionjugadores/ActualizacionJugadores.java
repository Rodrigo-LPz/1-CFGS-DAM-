...
public class ActualizacionJugadores{
    ...
    public void ejecutarActualizacionJugador(){
        ...
        // Asignadión de variables numéricas y no numéricas.
        ...
        // Muestreo de los datos actuales/modificados.
        ...
        // Declara un condicional d etipo "if" con el que cubrir el caso/s en el que el usuario haya introducido un valor como "campo" incorrecto o inválido.
        ...
        switch (campoActualizadoFinal){
            ...
            case "Nombre":
                if (parametroActualizado.length() < 2 || !parametroActualizado.matches("[a-zA-ZáéíóúÁÉÍÓÚÜäëïöüÄËÏÖÜàèìòùÀÈÌÒÙâêîôûÂÊÎÔÛñÑ\\s]+")){
                    System.err.println("ERROR: El valor introducido como nombre {" + parametroActualizado + "} no es válido. Recuerde que el valor a introducir debe contener al menos (2) carácteres no numéricos ni sí­mbolos.");
                    return;
                }
            ...
            case "Edad":
                ...
                try{
                    ...
                    actualizacion = new Document("$set", new Document("Edad", parametroActualizado));
            ...
            case "Dorsal":
                ...
                try{
                    ...
                    actualizacion = new Document("$set", new Document("Dorsal", parametroActualizado));
