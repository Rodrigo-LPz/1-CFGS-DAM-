    ...
    public void ejecutarRegistroJugador(){
        ...
        while (true){
            ...
            if (nombre.length() < 2){
                ...
                System.err.println("ERROR: El valor introducido como nombre {" + nombre + "} no es válido. Recuerde que el valor introducido no puede contener ni números ni sí­mbolos.");
            } else{
