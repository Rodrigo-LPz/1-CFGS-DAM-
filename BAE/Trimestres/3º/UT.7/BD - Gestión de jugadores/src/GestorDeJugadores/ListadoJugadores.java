...
public class ListadoJugadores{
    ...
    public void ejecutarListadoJugador(){
        ...
        // Declara una variable de tipo "boolean" con el fin de controlar si la colección está vacía.
        ...
        // Crea un condicional de tipo "if" para comprobar si la colección está vacía o no.
        if (!existenJugadores){
            System.err.println("ERROR: La colección sobre la que se está trabajando no existe o no contiene ningún registro, jugadores, (Está vacía).");
        }

        // Creación de las variables a usar.
        String respuesta, respuestaFinal, campo, campoFinal, parametro, parametroEstricto, parametroEstrictoFinal;
        
        // Pregunta al usuario si desea buscar a un jugador en concreto/específico.
        System.out.print("\n¿Desea buscar un jugador específico dentro de la colección de jugadores? → (Sí / No): ");
        ...
        if (!respuestaFinal.equals("No")){
            ...
            while (true){
                System.out.println("\n¿Y por cuál campo/parámetro le gustaría empezar a filtrar la búsqueda del jugador? (Nombre / Edad/ / Dorsal / Posición)");
                    ...
                    /*
                      *
                       *
                        ...
                        * La expresión regular "^" significa que la búsqueda tendrá que: “empezar por/con…”.
                        * La expresión regular "$" significa que la búsqueda tendrá que: terminar por/con…”.
            ...
            // Declara una variable de tipo "boolean" con un valor inicial "false" con el fin de manejar si la colección está vacía respecto al/a los jugador/es que se estén buscando.
