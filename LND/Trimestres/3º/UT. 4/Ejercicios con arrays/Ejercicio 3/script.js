...
function Concurso(){
    ...
    console.log("    2. Antonio queda eliminado/descalificado.");
    console.log("    3. Roberto y Amaya se colocan en el segundo y tercer puesto respectivamente.");
    console.log("    4. Celia adelanta a Raúl.");
    console.log("    5. Marta entra y se pone en cabeza.\n");
